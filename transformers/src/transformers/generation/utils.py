...
class GenerationMixin:
    ...
    def _get_cache(
        self, cache_implementation: str, batch_size: int, max_cache_len: int, device: torch.device, recompute_len: int, model_kwargs
    ) -> Cache:
        """
    ...
    def generate(
        ...
        **kwargs,
        ...
        self._prepare_cache_for_generation(
            generation_config, model_kwargs, assistant_model, batch_size, max_cache_length, device, recompute_len
        )
